        ...
        <div className="col-span-12 md:col-span-10 md:start-2">
          ...
          <div className="overflow-hidden mb-2 -mt-20 md:-mt-0">
            <motion.span
              ...
              className="block pt-4 pl-2 text-xs font-medium uppercase tracking-[0.3em] text-paper/80 md:text-charcoal"
            >
              Frontendutvecklare
            </motion.span>
          </div>
          ...
          <div className="overflow-hidden">
            <motion.h1
              ...
              className="font-serif text-4xl pt-4 pb-4 leading-[0.9] text-paper/80 md:text-charcoal md:text-6xl lg:text-7xl"
            >
              Mimmie Vänerhag
            </motion.h1>
          </div>
          ...
          <div className="overflow-hidden">
            ...
            >
              <Link
                to="/cv"
                className="rounded-3xl cursor-pointer bg-paper/10 border border-paper/80 md:border-charcoal text-paper/80 md:text-charcoal px-6 py-2 text-xs font-medium uppercase tracking-widest hover:bg-charcoal hover:text-paper transition-colors duration-300"
              >
                Om mig
              </Link>
